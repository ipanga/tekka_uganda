...
class _TwoFactorAuthScreenState extends ConsumerState<TwoFactorAuthScreen> {
    ...
    return ListView(
      ...
      children: [
        ...
        _BenefitItem(
          ...
          description: 'Even if someone gets your password, they can\'t access your account.',
        ),
        const SizedBox(height: AppSpacing.space3),
        _BenefitItem(
          icon: Icons.verified_user_outlined,
          title: 'Secure Transactions',
          description: 'Add protection when making sensitive changes to your account.',
        ),
        const SizedBox(height: AppSpacing.space3),
        _BenefitItem(
          icon: Icons.phone_android_outlined,
          title: 'Your Choice',
          description: 'Use SMS or an authenticator app - whichever works best for you.',
        ),
          ...
          child: Column(
            children: [
              ListTile(
                ...
                subtitle: const Text('Use these if you lose access to your device'),
              ...
              ListTile(
                ...
                subtitle: const Text('Generate new codes (old ones will stop working)'),
                trailing: const Icon(Icons.chevron_right),
              ...
              ListTile(
                ...
                subtitle: Text('Currently: ${status.activeMethod?.displayName ?? 'Unknown'}'),
                trailing: const Icon(Icons.chevron_right),
                onTap: () {
                  ref.read(twoFactorAuthProvider.notifier).startSetup();
                },
    ...
    return ListView(
      ...
      children: [
        ...
        _MethodCard(
          ...
          onTap: () {
            ref.read(twoFactorAuthProvider.notifier).selectMethod(TwoFactorMethod.sms);
          },
        ),
        ...
        _MethodCard(
          ...
          recommended: true,
          onTap: () {
            ref.read(twoFactorAuthProvider.notifier).selectMethod(TwoFactorMethod.authenticatorApp);
          },
        ),
        ...
        SizedBox(
          ...
          child: FilledButton(
            onPressed: status.isLoading
                ? null
                : () async {
                    await ref.read(twoFactorAuthProvider.notifier).sendSmsCode();
                  },
    ...
    return ListView(
      ...
      children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Clipboard.setData(ClipboardData(text: status.secretKey ?? ''));
        ...
        SizedBox(
          ...
          child: FilledButton(
            onPressed: () {
              ref.read(twoFactorAuthProvider.notifier).proceedToCodeVerification();
            },
  ...
  Future<void> _verifyCode() async {
    ...
    final success = await ref.read(twoFactorAuthProvider.notifier).verifyCode(code);
  ...
  Future<void> _regenerateBackupCodes() async {
    ...
    if (confirmed == true) {
      final newCodes =
          await ref.read(twoFactorAuthProvider.notifier).regenerateBackupCodes();
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () async {
              ...
              final success =
                  await ref.read(twoFactorAuthProvider.notifier).disable2FA();
              if (success && mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
