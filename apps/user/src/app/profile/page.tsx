        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            <Card>
              <CardContent className="py-4 text-center">
                <ShoppingBagIcon className="w-6 h-6 text-pink-600 mx-auto mb-2" />
            ...
            <Card>
              <CardContent className="py-4 text-center">
                <StarIcon className="w-6 h-6 text-pink-600 mx-auto mb-2" />
            ...
            <Card>
              <CardContent className="py-4 text-center">
                <ChatBubbleLeftRightIcon className="w-6 h-6 text-pink-600 mx-auto mb-2" />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            <Link href="/my-listings">
              <Card hoverable>
                <CardContent className="py-4 text-center">
                  <span className="text-pink-600 font-medium">My Listings</span>
                </CardContent>
              </Card>
            </Link>
            <Link href="/saved">
              <Card hoverable>
                <CardContent className="py-4 text-center">
                  <span className="text-pink-600 font-medium">Saved Items</span>
                </CardContent>
              </Card>
            </Link>
            <Link href="/offers">
            ...
            <Link href="/messages">
              <Card hoverable>
                <CardContent className="py-4 text-center">
                  <span className="text-pink-600 font-medium">Messages</span>
                </CardContent>
              </Card>
            </Link>
          </div>
