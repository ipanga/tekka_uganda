          ...
          {priceAlerts.length === 0 ? (
            ...
            <div className="space-y-4">
              {priceAlerts.map((alert) => (
                <Card
                  key={alert.id}
                  className={!alert.isRead ? 'ring-2 ring-primary-200' : ''}
                >
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <Link
                            href={`/listing/${alert.listingId}`}
                            className="font-medium text-gray-900 hover:text-primary-500 truncate"
                            onClick={() => !alert.isRead && handleMarkAsRead(alert.id)}
                          >
                            {alert.listingTitle}
                          </Link>
          ...
          <div className="mt-8 p-6 bg-white rounded-lg border border-gray-200">
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 rounded-full bg-primary-100 text-primary-500 flex items-center justify-center flex-shrink-0 text-xs font-medium">
                  1
                </span>
                <span>
