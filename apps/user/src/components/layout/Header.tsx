          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-2xl mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 bg-white text-gray-900 rounded-full focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent placeholder-gray-400"
              />
            </div>
          </form>
            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  ...
                  {chatCount > 0 && (
                    <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-primary-500 text-white text-xs rounded-full flex items-center justify-center px-1">
                ...
                <Menu as="div" className="relative">
                  <MenuButton className="flex items-center p-1 rounded-full hover:bg-gray-100">
                    <Avatar
                      src={user?.photoUrl}
                  ...
                  >
                    <MenuItems className="absolute right-0 mt-2 w-56 origin-top-right bg-white rounded-xl shadow-lg ring-1 ring-black/5 focus:outline-none divide-y divide-gray-100">
                      {/* User Info */}
                ...
                <Link
                  href="/sell"
                  className="bg-primary-500 text-white px-4 py-2 rounded-full hover:bg-primary-600 transition-colors flex items-center gap-2"
                >
            ...
            <nav className="flex flex-col space-y-3">
              {isAuthenticated ? (
                <>
                  ...
                  <Link
                    href="/messages"
                    className="text-gray-600 hover:text-primary-500 py-2 flex items-center justify-between"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Messages
                    {chatCount > 0 && (
                  ...
                  <Link
                    href="/sell"
                    className="bg-primary-500 text-white px-4 py-2 rounded-full text-center hover:bg-primary-600"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Sell Now
                  </Link>
                  <button
                    ...
                    className="text-gray-600 hover:text-primary-500 py-2 text-left"
                  >
                    Sign Out
                  </button>
                </>
